...
<body>
	<script>
		...
		function installApp() {
			...
			InstalledApps = InstalledApps+Separator+'<?php include $Name; ?>SEP0and0SEPPHPHOMEPATHassets/img/ACOS_0and0.png';
	...
	<div id="Main">
		...
		<div id="Image">
			<img src="<?php echo $home_path; ?>assets/img/ACOS_0and0.png"/>
		</div>
