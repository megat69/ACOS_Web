...
<body>
	<script>
		...
		function installApp() {
			...
			InstalledApps = InstalledApps+Separator+'<?php include $Name; ?>SEPkrunker-ioSEPhttps://files.apigame.com/files/image/krunker.PNG';
	...
	<div id="Main">
		...
		<div id="Image">
			<img src="https://files.apigame.com/files/image/krunker.PNG"/>
		</div>
